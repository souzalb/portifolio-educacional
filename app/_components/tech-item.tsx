...
const TechItem = ({ tech }: TechItemProps) => {
  ...
  return (
    <Card
      className="h-[440px] max-w-[300px] cursor-pointer rounded-2xl"
      // onClick={() => router.push(`/techs/${tech.id}`)}
    >
      <CardContent className="p-0 px-1 pt-1">
        ...
        <div className="flex h-[280px] flex-col justify-between px-2 py-3">
          ...
          >
            ...
            <p className="truncate text-sm text-gray-400">{tech.description}</p>
